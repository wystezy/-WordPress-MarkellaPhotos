 ...
 */
 ...
 ( function( $ ) {
	...
	// Color preview
	wp.customize( 'post_feed_button_border_color', function( value ) {
		value.bind( function( to ) {
			$( 'a.readmore-btn' ).css( {
				'border-color':to
			});
		...
		wp.customize( 'post_feed_button_text_color', function( value ) {
		value.bind( function( to ) {
			$( 'a.readmore-btn' ).css( {
				'color':to
			});
	...
	wp.customize( 'notes_and_photos_readmore_text', function( value ) {
		value.bind( function( to ) {
			$( 'a.read-more-btn' ).css( {
				'color':to
			});
		...
		wp.customize( 'notes_and_photos_readmore_bg', function( value ) {
		value.bind( function( to ) {
			$( 'a.read-more-btn' ).css( {
				'background':to
			});
